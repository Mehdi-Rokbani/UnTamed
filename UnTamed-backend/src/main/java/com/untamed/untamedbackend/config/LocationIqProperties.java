...
public class LocationIqProperties {
    ...
    private String staticMapBaseUrl = "https://maps.locationiq.com";
    private String apiKey;

    public String getBaseUrl() { return baseUrl; }
    public void setBaseUrl(String baseUrl) { this.baseUrl = baseUrl; }

    public String getStaticMapBaseUrl() { return staticMapBaseUrl; }
    public void setStaticMapBaseUrl(String staticMapBaseUrl) { this.staticMapBaseUrl = staticMapBaseUrl; }
